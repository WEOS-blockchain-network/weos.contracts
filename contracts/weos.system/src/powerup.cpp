#include <weos.system/weos.system.hpp>
#include <eosio/action.hpp>
#include <weos.system/powerup.results.hpp>
#include <algorithm>
#include <cmath>
...
void system_contract::cfgpowerup(powerup_config& args) {
   ...
   eosio::check(eosio::is_account(reserv_account), "weos.reserv account must first be created");
