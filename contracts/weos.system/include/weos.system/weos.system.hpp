...
#include <weos.system/exchange_state.hpp>
#include <weos.system/native.hpp>
...
namespace eosiosystem {
   ...
   */
   ...
   struct [[eosio::table, eosio::contract("weos.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[eosio::table, eosio::contract("weos.system")]] bid_refund {
      name         bidder;
      asset        amount;
   ...
   struct [[eosio::table("global"), eosio::contract("weos.system")]] eosio_global_state : eosio::blockchain_parameters {
   ...
   struct [[eosio::table("global2"), eosio::contract("weos.system")]] eosio_global_state2 {
      eosio_global_state2(){}
   ...
   struct [[eosio::table("global3"), eosio::contract("weos.system")]] eosio_global_state3 {
      eosio_global_state3() { }
   ...
   struct [[eosio::table("global4"), eosio::contract("weos.system")]] eosio_global_state4 {
      eosio_global_state4() { }
   ...
   struct [[eosio::table, eosio::contract("weos.system")]] producer_info {
      name                                                     owner;
   ...
   struct [[eosio::table, eosio::contract("weos.system")]] producer_info2 {
      name            owner;
   ...
   struct [[eosio::table, eosio::contract("weos.system")]] voter_info {
   ...
   struct [[eosio::table, eosio::contract("weos.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
   ...
   struct [[eosio::table, eosio::contract("weos.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("weos.system")]] refund_request {
      name            owner;
   ...
   struct [[eosio::table,eosio::contract("weos.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   struct [[eosio::table,eosio::contract("weos.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   struct [[eosio::table,eosio::contract("weos.system")]] rex_return_buckets {
      uint8_t                           version = 0;
   ...
   struct [[eosio::table,eosio::contract("weos.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   struct [[eosio::table,eosio::contract("weos.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   struct [[eosio::table,eosio::contract("weos.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   struct [[eosio::table,eosio::contract("weos.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
   ...
   struct [[eosio::table("powup.state"),eosio::contract("weos.system")]] powerup_state {
   ...
   struct [[eosio::table("powup.order"),eosio::contract("weos.system")]] powerup_order {
      uint8_t              version = 0;
      uint64_t             id;
      name                 owner;
      int64_t              net_weight;
    ...
    */
   class [[eosio::contract("weos.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name token_account{"weos.token"_n};
         static constexpr eosio::name ram_account{"weos.ram"_n};
         static constexpr eosio::name ramfee_account{"weos.ramfee"_n};
         static constexpr eosio::name stake_account{"weos.stake"_n};
         static constexpr eosio::name bpay_account{"weos.bpay"_n};
         static constexpr eosio::name vpay_account{"weos.vpay"_n};
         static constexpr eosio::name names_account{"weos.names"_n};
         static constexpr eosio::name saving_account{"weos.saving"_n};
         static constexpr eosio::name rex_account{"weos.rex"_n};
         static constexpr eosio::name reserv_account{"weos.reserv"_n};
         static constexpr eosio::name null_account{"weos.null"_n};
